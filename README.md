...
| Project | Description |
|---------|-------------|
| [tlos](https://github.com/igor53627/tlos) | Topology-Lattice Obfuscation for Smart Contracts; four-layer security (topology, LWE, wire binding, puzzle) protects low-entropy secrets on-chain. ~3.3M gas for 128 gates, 99.6% storage reduction. Enables password-gated vaults, sealed-bid auctions, and on-chain treasure hunts. |
